...
<table id="notice" class="view">
		...
		<tr><td>map</td><td colspan="3" class="con">
		<img src="../upload/<%=gbb.getFile()%>" width="300" height="200"><br></td></tr>
</table>
<!-- Comment -->
<form action="gcommentPro.jsp" method="post" class="comm">
	<div class="comment">		
	<p>Comments</p>
<%
...
if(ccount!=0){
	...
	if(id.equals(cb.getId())){
		%>
		<input type="button" value="Update" onclick="location.href='gcontent.jsp'" class="comButton">
		
		<p><textarea name="comment" cols=90 rows=3><%=cb.getComment() %></textarea></p></div>
