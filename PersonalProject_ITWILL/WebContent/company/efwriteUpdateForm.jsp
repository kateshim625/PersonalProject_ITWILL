...
GalleryBoardBean gbb = gbdao.getGalleryBoard(num); //호출해서 게시판 글다가져오게

%>
<article>
<h1>Gallery Update</h1>
<form action="gfwriteUpdatePro.jsp" method="post" enctype="multipart/form-data">
<input type="hidden" name="num" value="<%=num%>">
<table id="notice" class="update">			
	<tr><td>Writer</td><td><input type="text" name="id" value="<%=gbb.getWriter() %>" readonly></td></tr>
	<tr><td>Password</td><td><input type="password" name="pass"></td></tr>
	<tr><td>Title</td><td><input type="text" name="subject" value="<%=gbb.getTitle() %>"></td></tr>
	<tr><td>Attached</td><td><input type="file" name="file">
	<input type="hidden" name="old_file" value="<%=gbb.getFile() %>"><br><%=gbb.getFile() %></td></tr>
	<tr><td>Content</td>
	<td><textarea name="content" cols="50" rows="10" value=""><%=gbb.getContent() %></textarea></td></tr>
</table>
