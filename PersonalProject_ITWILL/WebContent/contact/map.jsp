...
<nav id="sub_menu">
<ul>
<li><a href="../contact/mailForm.jsp">Join us</a></li>
...
<table id="notice">
		...
		<div id="daumRoughmapContainer1578556852377" class="root_daum_roughmap root_daum_roughmap_landing" width="500px;"></div>
<!--
	2. 설치 스크립트
