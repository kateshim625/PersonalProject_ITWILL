...
BoardBean bb = bdao.getBoard(num); //호출해서 게시판 글다가져오게

%>
<article>
<h1>Notice Write Update</h1>
<form action="writeUpdatePro.jsp" method="post">
<input type="hidden" name="num" value="<%=num%>">
<table id="notice" class="update">			
	<tr><td>Writer</td><td><input type="text" name="id" value="<%=bb.getWriter() %>" readonly></td></tr>
	<tr><td>Password</td><td><input type="password" name="pass"></td></tr>
	<tr><td>Title</td><td><input type="text" name="subject" value="<%=bb.getTitle() %>"></td></tr>
	<tr><td>Content</td>
	<td><textarea name="content" cols="50" rows="10" value=""><%=bb.getContent() %></textarea></td></tr>
</table>
