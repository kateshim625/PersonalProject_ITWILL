...
FileBoardBean fbb = fbdao.getFileBoard(num); //호출해서 게시판 글다가져오게

%>
<article>
<h1>File Notice Write Update</h1>
<form action="fwriteUpdatePro.jsp" method="post" enctype="multipart/form-data">
<input type="hidden" name="num" value="<%=num%>">
<table id="notice" class="update">			
	<tr><td>Writer</td><td><input type="text" name="id" value="<%=fbb.getWriter() %>" readonly></td></tr>
	<tr><td>Password</td><td><input type="password" name="pass"></td></tr>
	<tr><td>Title</td><td><input type="text" name="subject" value="<%=fbb.getTitle() %>"></td></tr>
	<tr><td>Attached</td><td><input type="file" name="file">
	<input type="hidden" name="old_file" value="<%=fbb.getFile() %>"><br><%=fbb.getFile() %></td></tr>
	<tr><td>Content</td>
	<td><textarea name="content" cols="50" rows="10" value="<%=fbb.getContent() %>"><%=fbb.getContent() %></textarea></td></tr>
</table>
